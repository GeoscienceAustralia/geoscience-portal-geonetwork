  ...
  <xsl:template match="/">
    ...
    <xsl:template match="*" mode="metadata">
        ...
        <xsl:for-each select="gmd:identificationInfo//gmd:MD_DataIdentification|
            ...
            <!-- authorSurname -->
            <xsl:for-each select="gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:individualName/gco:CharacterString|gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:individualName/gco:CharacterString">
        ...
        <!-- Index thesaurus type -->
          ...
          <xsl:if test="$indexAllKeywordDetails">
            ...
            <xsl:for-each select="gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:organisationName/gco:CharacterString
                |gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:organisationName/gmx:Anchor">
      ...
      <xsl:for-each select="srv:coupledResource">
        ...
        <xsl:for-each select="gmd:onLine/gmd:CI_OnlineResource[gmd:linkage/gmd:URL!='']">
          ...
          <xsl:if test="string($name)!=''">
            <Field name="linkageName" string="{string($name)}" store="true" index="true"/>
          </xsl:if>
